...
const ResendConfirmation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (email !== '' && isValidEmail) {
      ...
      setIsError(false);
      setIsValidEmail(true);
      dispatch(accountActions.onResendConfirmation(email)).then((res) => {
        if (res?.success) 
        {
          setIsSuccess(true);
          Amplitude(
      ...
      {isLoading && <Loader />}
        <div className="grayBackground">
          <div className="loginWrapper">
            ...
            {!isSuccess ? (
            <div>
              <span className="signInTitle">Resend verification email.</span>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className="signInBtnWrapper">
                    <button className="loginBtn">
                      <span className="loginTxt">Request verification email</span>
                    </button>
                  </div>
