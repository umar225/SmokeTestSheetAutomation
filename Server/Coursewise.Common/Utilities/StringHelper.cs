...
namespace Coursewise.Common.Utilities
{
    ...
    {
        private static void SetUrl(string normalizedString, StringBuilder stringBuilder,int maxLength)
        {
        ...
        public static string UrlFriendly(string text, int maxLength = 0)
        {
            ...
            SetUrl(normalizedString,stringBuilder,maxLength);
    ...
    public static class ConstHelper
    {
        ...
        public static string RemapInternationalCharToAscii(char c)
        {
            ...
            {
                return getRemainingRemappedInternationalCharToAscii(c, s);
            }
            
        }
        public static string getRemainingRemappedInternationalCharToAscii(char c, string s)
        {
            if ("śşšŝ".Contains(s))
            {
                return "s";
